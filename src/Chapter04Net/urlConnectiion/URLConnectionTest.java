package Chapter04Net.urlConnectiion;
    ...
    public static void main(String[] args) {
        try{
           ...
           if(args.length>0) urlName=args[0];
            ...
            System.out.println("getContetLength: " + urlConnection.getContentLength());
            System.out.println("getContentEncoding: " + urlConnection.getContentEncoding());
            System.out.println("getData :" + urlConnection.getDate());
            ...
            try (Scanner in = new Scanner(urlConnection.getInputStream(),"UTF-8")){
